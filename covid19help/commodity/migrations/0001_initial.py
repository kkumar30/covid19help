# Generated by Django 2.2.10 on 2020-03-28 03:53
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('meds', 'Pharmaceutical Medicines'), ('mask', 'Masks'), ('sanitizer', 'Sanitizers'), ('food', 'Food'), ('other', 'Other')], max_length=128)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('balance', djmoney.models.fields.MoneyField(decimal_places=2, max_digits=5)),
                ('currency', models.CharField(default='USD', max_length=3)),
                ('category', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='category', to='commodity.Category')),
